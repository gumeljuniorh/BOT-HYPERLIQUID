...
export interface ScannerOpportunity {
  ...
  longScore?: number;
  shortScore?: number;
  selectedSide?: "LONG" | "SHORT" | "NONE" | string;
  setupType?: string;
  leverageTier?: number;
  sizeTier?: string;
  cmcDirectionalBias?: string;
  hlDirectionalConfirmation?: string;
  sideReason?: string;
  finalExecutionScore?: number;
  cmcTrendScore?: number;
  momentumPersistenceScore?: number;
  regimeScore?: number;
  volumeScore?: number;
  spreadSlippageScore?: number;
  feeAdjustedExpectedValue?: number;
  narrative?: string;
  action?: string;
